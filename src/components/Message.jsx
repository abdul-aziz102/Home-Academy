  ...
  return (
    <>
      ...
      <div
        ...
        className="fixed bottom-4 right-4 z-50 bg-gradient-to-r from-indigo-500 to-purple-600 hover:opacity-90 text-white p-4 rounded-full shadow-lg cursor-pointer md:bottom-6 md:right-6"
      >
