    ...
    <div className="bg-gray-50">
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            {features.map((feature, index) => (
              <div key={index} className="bg-gray-50 p-5 rounded-xl text-center hover:shadow-md transition-shadow duration-300">
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="flex justify-center mb-8">
            <div className="inline-flex rounded-md shadow-sm" role="group">
              <button type="button" className="px-4 py-2 text-sm font-medium text-indigo-700 bg-indigo-100 rounded-l-lg hover:bg-indigo-200 focus:z-10 focus:outline-none focus:ring-1 focus:ring-indigo-500">
                All Levels
              </button>
              <button type="button" className="px-4 py-2 text-sm font-medium text-gray-700 bg-white hover:bg-gray-100 focus:z-10 focus:outline-none focus:ring-1 focus:ring-indigo-500">
                Beginner
              </button>
              <button type="button" className="px-4 py-2 text-sm font-medium text-gray-700 bg-white hover:bg-gray-100 focus:z-10 focus:outline-none focus:ring-1 focus:ring-indigo-500">
                Intermediate
              </button>
              <button type="button" className="px-4 py-2 text-sm font-medium text-gray-700 bg-white hover:bg-gray-100 rounded-r-lg focus:z-10 focus:outline-none focus:ring-1 focus:ring-indigo-500">
                Advanced
              </button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {levels.map((level, index) => (
              <div
                key={index}
                className="bg-white rounded-lg shadow-sm overflow-hidden hover:shadow-md transition-shadow duration-300 border border-gray-200 hover:border-indigo-300"
              >
                ...
                <div className="p-5">
                  ...
                  <div className="mb-4">
                    <h4 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">You'll Learn:</h4>
                    <ul className="space-y-1">
                      {level.skills.map((skill, i) => (
                        <li key={i} className="flex items-start">
                          <FaCheck className="w-3 h-3 mr-2 mt-0.5 text-green-500 flex-shrink-0" />
                  ...
                  <div className="border-t border-gray-200 pt-3">
                    <div className="flex justify-between items-center mb-3">
                      ...
                      <span className="text-xs text-gray-500">
                        {level.intensity || level.classes}
                      </span>
                    </div>
                    <Link to='/register'>
                      <button className="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-2 rounded-md font-medium text-sm transition duration-300">
                        Enroll Now
                      </button>
                    </Link>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white p-5 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-center mb-4">
                <img src="mudasir.png" alt="Student" className="w-10 h-10 rounded-full mr-3" />
                <div>
                  <h4 className="font-semibold">Muddasir</h4>
                  <p className="text-xs text-gray-500">Beginner Level Graduate</p>
                </div>
              </div>
              <p className="text-gray-600 text-sm italic">"The teachers at Home Academy are incredibly patient and knowledgeable. I went from knowing nothing to having basic conversations in just 3 months!"</p>
            ...
            <div className="bg-white p-5 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-center mb-4">
                <img src="talal.png" alt="Student" className="w-10 h-10 rounded-full mr-3" />
                <div>
                  <h4 className="font-semibold">Muhummad Talal</h4>
                  <p className="text-xs text-gray-500">Intermediate Level</p>
                </div>
              </div>
              <p className="text-gray-600 text-sm italic">"The interactive classes and practical exercises helped me improve my English for my job. I can now communicate confidently with international clients."</p>
              <div className="flex mt-3 text-yellow-400">
                {[...Array(5)].map((_, i) => (
                  <svg key={i} className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
            ...
            <div className="bg-white p-5 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-center mb-4">
                <img src="bilala.png" alt="Student" className="w-10 h-10 rounded-full mr-3" />
                <div>
                  <h4 className="font-semibold">Muhummad Bilal</h4>
                  <p className="text-xs text-gray-500">Advanced Level</p>
                </div>
              </div>
              <p className="text-gray-600 text-sm italic">"Thanks to Home Academy, I scored band 7.5 in IELTS and got admission to my dream university abroad. The personalized attention made all the difference."</p>
              <div className="flex mt-3 text-yellow-400">
                {[...Array(5)].map((_, i) => (
                  <svg key={i} className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
      ...
      <section className="py-16 bg-gradient-to-r from-indigo-700 to-blue-600 text-white">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link to='/register'>
              <button className="bg-white text-indigo-700 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition duration-300 text-sm sm:text-base">
                Enroll Now
              </button>
            </Link>
            <Link to="/contact">
              <button className="border-2 border-white text-white px-6 py-3 rounded-lg font-semibold hover:bg-white hover:text-indigo-700 transition duration-300 text-sm sm:text-base">
                Contact Us
              </button>
            </Link>
          </div>
